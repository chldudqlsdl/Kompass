...
struct Constants {
    ...
    struct Prologue {
        static let title : [String : String] = [
            ...
            "system1" : "Letter in English and Korean",
            "system2" : "Korean Letter",
            "system3" : "Korean Word",
            ...
            "vowel3" : "Let's Study with Writing.",
            "batchim0" : "Batchim",
        ...
        static let text : [String : String] = [
            ...
            "onboarding1" : "**Kompass** is the easiest way to help people who want to read **Hangul** quickly. Learn Hangul in a flash.",
            "onboarding2" : "**Kompass** researches the most efficient methods for each part, providing easy and detailed guidance.",
            ...
            "system2" : "A Korean letter is **a combination of consonants and vowels**, so basically the form is **C+V** or **C+V+C**.",
            "system3" : "A Korean word is **a combination of letters**. Is it hard? \n\n **Learning Hangul won't be difficult, so give it a try!**",
            "consonant0" : "There are **19 consonants** used in Hangul.",
            "consonant1" : "Consonants are speech sounds made by **blocking the flow of air from the mouth**.",
            "consonant2" : "**Associative Memory** is an effective teaching method, so we’ll teach you **consonants** through Associative Memory.",
            "consonant3" : "**Consonants** can't make their own sounds, and it's **a rule to make sounds only when combined with vowels**.",
            ...
            "vowel1" : "Vowels are a speech sounds made with **mouth open** and **tongue not touching teeth, lips, etc**.",
            ...
            "batchim2" : "**Batchims** can sometimes produce different sounds depending on whether they are in the **first position** or in the **final position**.",
